...
import {
  ...
  listEdits,
  requestChanges,
} from "@/features/capabilities/asset_review_with_timecodes/api";
import { EditCommentsList } from "@/features/capabilities/asset_review_with_timecodes/components/EditCommentsList";
import { UploadDialog } from "@/features/capabilities/asset_review_with_timecodes/components/UploadDialog";
import {
  VideoReviewPlayer,
  type VideoReviewPlayerHandle,
} from "@/features/capabilities/asset_review_with_timecodes/components/VideoReviewPlayer";
import type { EditComment, EditVersion } from "@/features/capabilities/asset_review_with_timecodes/types";
        ...
        <Card>
          <CardHeader className="flex flex-row flex-wrap items-center justify-between gap-2">
            ...
            <div className="flex gap-2">
              {canRequestChanges && current.status !== "approved" && (
                <AlertDialog>
