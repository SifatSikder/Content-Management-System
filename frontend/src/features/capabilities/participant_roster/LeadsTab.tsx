...
/**
 * Lead form variant of the `participant_roster` capability.
 *
 * Shares the `participants` table + `/cast` routes with `CastingTab`, but
 * renders only the fields the Marketing template's `capability_configs.
 * participant_roster.visible_fields` whitelist surfaces: display name,
 * email, phone, source, notes. No release-form upload, no confirm toggle.
 *
